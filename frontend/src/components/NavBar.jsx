...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white shadow-md p-4 flex justify-between items-center">
      {/* Logo */}
      <h1 className="text-xl font-semibold ml-10 text-gray-800 ">Question Paper Generation System</h1>
    ...
    <div className="lg rounded-lg p-4 w-72 flex flex-col items-center">
      ...
      <div className="text-center mb-4">
        <h3 className="text-lg font-semibold text-gray-800">Charanraj</h3>
